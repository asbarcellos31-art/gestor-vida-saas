...
import HomeSimples from "./pages/HomeSimples";
...
import AnaliseHistorica from "./pages/AnaliseHistorica";
...
function ProtectedRoute({ component: Component }: { component: React.ComponentType }) {
  ...
  if (subscription !== undefined && !plan && !isAdmin) {
...
function Router() {
  ...
  return (
    <Switch>
      <Route path="/" component={HomeSimples} />
      <Route path="/nova" component={HomeSimples} />
      ...
      <Route path="/analise-historica">{() => <ProtectedRoute component={AnaliseHistorica} />}</Route>
