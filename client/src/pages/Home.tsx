    ...
    <div className="min-h-screen" style={{ background: "#0B1437" }}>
      ...
      <section id="metodo" className="py-20 px-4" style={{ background: "#0D1B4B" }}>
        <div className="container max-w-6xl mx-auto">
          ...
          {/* CTA - Aposentadoria com WhatsApp e Ebook */}
          <div
            className="mt-24 p-10 rounded-2xl text-center"
            style={{
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: "#F0E6C8" }}>
              Pronto para transformar sua aposentadoria?
            </h3>
            <p className="text-base md:text-lg leading-relaxed mb-8 max-w-2xl mx-auto" style={{ color: "#C8D8E8" }}>
              Quer ajuda de um especialista para estruturar seu futuro? Ou prefere aprender como aplicar seu dinheiro de forma estratégica para alcançar sua independência financeira?
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              {/* Botão WhatsApp */}
              <a
                href="https://wa.me/5548991860742?text=Olá%20Anderson!%20Gostaria%20de%20conversar%20sobre%20meu%20planejamento%20de%20aposentadoria."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
                  className="font-semibold px-8 py-6 text-base flex items-center gap-2 whitespace-nowrap"
                  style={{
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.946 1.347l-.355.203-.368-.057c-1.264-.187-2.494-.545-3.635-1.073l.635 3.999c1.824-2.692 4.614-4.565 7.708-4.565 5.06 0 9.169 4.106 9.169 9.166 0 .965-.165 1.905-.485 2.8l.231.369c.016 0 .016.016.032.031 1.901-1.494 3.144-3.885 3.144-6.6 0-5.061-4.11-9.166-9.169-9.166z"/>
                  </svg>
            ...
            {/* Nota explicativa */}
            <p className="text-xs mt-6" style={{ color: "#5A6A80" }}>
              Ebook: Alocação Macro para Investidores Iniciantes — com planilha prática incluída
            </p>
          </div>
        </div>
      </section>
