  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Card de boas-vindas */}
        <div className="bg-card rounded-2xl border border-border/50 shadow-sm p-6 mb-8 text-left">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Comece a usar agora mesmo</p>
            </div>
          </div>
